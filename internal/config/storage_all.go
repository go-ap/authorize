...
func getBadgerStorage(c StorageConfig, l lw.Logger) (authorize.FullStorage, error) {
...
func getBoltStorage(c StorageConfig, l lw.Logger) (authorize.FullStorage, error) {
...
func getSqliteStorage(c StorageConfig, l lw.Logger) (authorize.FullStorage, error) {
...
func getFsStorage(c StorageConfig, l lw.Logger) (authorize.FullStorage, error) {
