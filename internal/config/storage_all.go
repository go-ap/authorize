...
func getBadgerStorage(c Storage, l lw.Logger) (authorize.FullStorage, error) {
...
func getBoltStorage(c Storage, l lw.Logger) (authorize.FullStorage, error) {
...
func getSqliteStorage(c Storage, l lw.Logger) (authorize.FullStorage, error) {
...
func getFsStorage(c Storage, l lw.Logger) (authorize.FullStorage, error) {
...
func NewStorage(c Storage, env Env, l lw.Logger) (authorize.FullStorage, error) {
